...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/fceaefd1-747b-4578-b7bc-0800fa3b5ba7"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="fceaefd1-747b-4578-b7bc-0800fa3b5ba7"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/3b595a18-d632-4cbe-86d5-aa22e3f0258c"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="3b595a18-d632-4cbe-86d5-aa22e3f0258c"
fi
echo ${Vmess_UUID}
